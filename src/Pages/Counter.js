...
const Counter=()=> {
    ...
    return (
        ...
        <div className='text-center text-white mt-5'>
            <div className='h3'>Timer </div>
            <h1>{counter}</h1>
            <button disabled={started} onClick={start} className="btn btn-success m-2">Start</button>
            <button onClick={stop} className="btn btn-danger m-2">Stop</button>
...
export default Counter
>>>>>>> 0389174572a41736029a47bca0f2bc08772a6627
